...
var T = {
  en: {
    ...
    topbar: '🇩🇪 Made in Germany · Since 2000 &nbsp;·&nbsp; Exclusive distributor in Alanya: <span>HARIKA-M</span> &nbsp;·&nbsp; Free home consultation available',
    ...
    heroBtnWa: "💬 Free Consultation", heroBtnOutline: "See All Products ↓",
    ...
    solBtn:"💬 Try It Free — Book Consultation",
    ...
    advEyebrow:"Free consultation",advH2:"Personal Sleep Advice",
    advLead:"Mila and the HARIKA-M team speak English, Turkish and Russian. Book a free home visit — we come to you, bring products to try, and help you find the perfect solution.",
    advLangs:"🗣️ We speak: English · Türkçe · Русский",advLangsP:"Our Alanya team includes native speakers in all three languages.",
    advS1:"<strong>Book via WhatsApp</strong> — tell us your address and preferred time.",
    advS2:"<strong>We visit your home</strong> — bring samples and answer all your questions.",
    advS3:"<strong>Try everything</strong> — no pressure, no hard sell. Try the oscillation yourself.",
    advS4:"<strong>Personal recommendation</strong> — we match you to the right product for your body and budget.",
    advS5:"<strong>Zero pressure</strong> — we leave and you decide in your own time. No obligation.",
    advBtn:"💬 Book Free Consultation",
    ...
    ctxLead:"Book a free home consultation, ask about a product, or just say hello. We respond quickly in English, Turkish and Russian.",
    ...
    ctaBannerH:"Book Your Free Home Consultation",ctaBannerP:"We come to you — anywhere in Alanya. Try the products, ask everything, zero obligation.",ctaBannerBtn:"💬 Book via WhatsApp",
  ...
  tr: {
    ...
    topbar: "🇩🇪 Almanya'da Üretildi · 2000'den Beri &nbsp;·&nbsp; Alanya'daki Resmi Distribütör: <span>HARIKA-M</span> &nbsp;·&nbsp; Ücretsiz Ev Danışmanlığı",
    ...
    heroBtnWa:"💬 Ücretsiz Danışma",heroBtnOutline:"Tüm Ürünler ↓",
    ...
    solBtn:"💬 Ücretsiz Deneyin — Randevu Alın",
    ...
    advEyebrow:"Ücretsiz danışma",advH2:"Kişisel Uyku Danışmanlığı",
    advLead:"Mila ve HARIKA-M ekibi İngilizce, Türkçe ve Rusça konuşur. Ücretsiz ev ziyareti planlayın — size geliyoruz, denemeniz için ürünler getiriyoruz ve mükemmel çözümü bulmanıza yardımcı oluyoruz.",
    advLangs:"🗣️ Konuştuğumuz diller: English · Türkçe · Русский",advLangsP:"Alanya ekibimizde üç dilde de anadili konuşucuları bulunmaktadır.",
    advS1:"<strong>WhatsApp ile randevu alın</strong> — adresinizi ve tercih ettiğiniz saati bize bildirin.",
    advS2:"<strong>Evinizi ziyaret ediyoruz</strong> — örnekler getiriyoruz ve tüm sorularınızı yanıtlıyoruz.",
    advS3:"<strong>Her şeyi deneyin</strong> — baskı yok, satış dayatması yok. Salınımı kendiniz deneyin.",
    advS4:"<strong>Kişisel tavsiye</strong> — sizi vücudunuza ve bütçenize göre doğru ürünle eşleştiriyoruz.",
    advS5:"<strong>Zorunluluk yok</strong> — gidiyoruz ve siz kendi zamanınızda karar veriyorsunuz. Yükümlülük yok.",
    advBtn:"💬 Ücretsiz Randevu Alın",
    ...
    ctxLead:"Ücretsiz ev danışmanlığı rezervasyonu yapın, bir ürün hakkında sorun veya sadece merhaba deyin. İngilizce, Türkçe ve Rusça hızla yanıt veriyoruz.",
    ...
    ctaBannerH:"Ücretsiz Ev Danışmanlığı Randevusu Alın",ctaBannerP:"Size geliyoruz — Alanya'nın her yerine. Ürünleri deneyin, her şeyi sorun, hiçbir yükümlülük yok.",ctaBannerBtn:"💬 WhatsApp ile Rezervasyon Yapın",
  ...
  ru: {
    ...
    topbar: '🇩🇪 Сделано в Германии · С 2000 года &nbsp;·&nbsp; Официальный дистрибьютор в Алании: <span>HARIKA-M</span> &nbsp;·&nbsp; Бесплатная консультация на дому',
    ...
    heroBtnWa:"💬 Бесплатная консультация",heroBtnOutline:"Все товары ↓",
    ...
    advEyebrow:"Бесплатная консультация",advH2:"Персональные советы по сну",
    advLead:"Мила и команда HARIKA-M говорят на английском, турецком и русском. Закажите бесплатный визит на дом — мы приедем, привезём продукты и поможем найти идеальное решение.",
    advLangs:"🗣️ Мы говорим: English · Türkçe · Русский",advLangsP:"В нашей команде в Алании есть носители всех трёх языков.",
    advS1:"<strong>Запишитесь через WhatsApp</strong> — сообщите адрес и удобное время.",
    advS2:"<strong>Мы приезжаем к вам</strong> — привозим образцы и отвечаем на все вопросы.",
    advS3:"<strong>Пробуйте всё</strong> — без давления, без навязывания. Почувствуйте осцилляцию сами.",
    advS4:"<strong>Персональная рекомендация</strong> — подбираем продукт под ваше тело и бюджет.",
    advS5:"<strong>Никакого давления</strong> — мы уходим, вы решаете в своё время. Без обязательств.",
    advBtn:"💬 Записаться бесплатно",
    ...
    ctaBannerH:"Запишитесь на бесплатную консультацию на дому",ctaBannerP:"Приедем к вам — в любое место Алании. Пробуйте продукты, задавайте всё что хотите, без обязательств.",ctaBannerBtn:"💬 Записаться через WhatsApp",
